...
def add_like(msg_id):
    ...
    # msg = Likes.query.get_or_404(msg_id)
    ...
    #     delete_likes = Likes.query.filter_by((Likes.message_id == msg_id))
...
def edit_profile():
    ...
    if form.validate_on_submit():
        ...
        flash(f"{user.username}, password doesn't match! please try again.", 'danger')
